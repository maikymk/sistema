<?php
/**
 * Exibe os lancamentos para o usuario
 * O array de lancamentos so existe se tiver um array
 * com os dados da categoria com status = 1 e os dados do tipo de lancamento com status = 1.
 * Os lancamentos sao dependentes de categoria e tipo lancamento
 */
?>
<div class="container">
    <div class="row">
    ...
    <div class="table-responsive">
        <table id="table-categorias" class="table table-bordered col-md-12">
            ...
            <?php
            //verifica se o array de lancamentos esta preenchido
            if (!empty($this->lancamentos)) {
