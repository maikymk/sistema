...
<?php
/**
 * Usa o array campos pra armazenar os dados
 * que o usuario tentou cadatrar, se tiver algum dado
 * exibe no input do campo correspondente
 */
...
/**
 * variavel definida pra marcar a opcao 
 * que o usuario marcou no select
 */
...
<div class="container">
    ...
    <?php
      //Verifica se existe algum erro. Se existir percorre o array e exibe ele na tela
      if (!empty($this->erros)) { ?>
    ...
    <?php }?>
    <?php
    //Verifica se existe alguma mensagem de sucesso. Se existir percorre o array e exibe ele na tela
    if (!empty($this->sucessos)) {?>
    <div class="row col-md-12 mk-mar-top-20">
    ...
    //verifica se existe categorias, se existir exibe elas
    ...
    <form class="mk-pad-bot-10" method="POST" action="">
        ...
        <div class="row mk-mar-bot-10 mk-pad-0">
            <div class="col-md-6">
                <label for="valor">Valor</label> <input type="text" id="valor" placeholder="R$ " name="valorLancamento" class="form-control" value="<?php echo $campos['valor']?>" data-thousands="." data-decimal="," required="required" />
            </div>
            <div class="col-md-6">
                <label for="data">Data</label> <input type="text" id="data" name="dataLancamento" class="form-control" placeholder="Data" value="<?php echo $campos['data']?>" required="required" min="<?php echo date('Y-m-d', strtotime('today'))?>">
            </div>
        </div>
        <div class="row mk-mar-bot-10 mk-pad-0">
            <div class="col-md-6">
                <label for="categoria">Categoria</label> <select id="categoria" class="mk-wid-100-prc" name="categLancamento">
                    <option value="">Selecione uma categoria</option>
                    <?php //percorre o array de categorias e exibe elas 
            ...
            <div class="col-md-6">
                <label for="tipo">Tipo</label> <select id="tipo" class="mk-wid-100-prc" name="tipoLancamento">
                    <option value="">Selecione um tipo de receita</option>
                    <?php //percorre o array de tipos de lancamento e exibe eles 
                    foreach ($this->receitas as $rec) {?>
    ...
    <?php } else {
        //se nao existir categorias exibe uma msg de erro
    ?>
    <div class="row">
        <div class="col-md-12">
